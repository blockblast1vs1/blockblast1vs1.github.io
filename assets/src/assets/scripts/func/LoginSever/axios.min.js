(function(e, t) {
    ...
    var l, d = Object.prototype.toString,
        p = Object.getPrototypeOf,
        h = (l = Object.create(null),
            function(e) {
                var t = d.call(e);
    ...
    function x(t, n) {
        var r = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).allOwnKeys,
            o = void 0 !== r && r;
        if (null !== t && "undefined" != typeof t) {
            var i, a;
            "object" !== e(t) && (t = [t]);
            if (v(t))
                for (i = 0, a = t.length; i < a; i++) n.call(null, t[i], i, t);
            else {
    ...
    var k, U = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : global,
        _ = function(e) {
            return !b(e) && e !== U;
        },
    ...
    function Z(t, n, r) {
        ...
        var o = (r = H.toFlatObject(r, {
            ...
            a = r.dots,
            s = r.indexes,
            u = (r.Blob || "undefined" != typeof Blob && Blob) && H.isSpecCompliantForm(n);
    ...
    var pe = de,
        he = H.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
        me = function(e) {
            var t, n, r, o = {};
            e && e.split("\n").forEach(function(e) {
                r = e.indexOf(":");
